<div class="answers index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('date_posted');?></th>
			<th><?php echo $this->Paginator->sort('date_last_edited');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $answer['Answer']['date_posted']; ?>&nbsp;</td>
		<td><?php echo $answer['Answer']['date_last_edited']; ?>&nbsp;</td>
		<td>
